...
import com.foodlog.repository.ClientRepository;
...
public class ClientResourceIntTest {
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getTelegramId()).isEqualTo(DEFAULT_TELEGRAM_ID);
    ...
    public void updateClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getTelegramId()).isEqualTo(UPDATED_TELEGRAM_ID);
